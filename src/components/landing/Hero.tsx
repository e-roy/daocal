...
const Hero = () => {
  return (
    <div className="flex flex-col  mx-auto -mt-20 overflow-hidden bg-gradient-to-r from-stone-700 to-stone-700">
        ...
        <div className="w-full md:w-2/3">
          <div className="flex flex-col items-start justify-center w-full h-full pb-20">
            ...
            <div className="flex flex-col items-start my-4 text-left lg:pl-10">
              <p className="max-w-md mb-10 text-base font-light text-stone-200 sm:text-lg lg:text-xl dark:text-dark-200">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab laborum deleniti eius aliquam tenetur
                quisquam maiores tempora odit, distinctio ex porro dolore atque nulla a dolorum similique ratione
      ...
      <div className="absolute  top-0 left-0 z-0 flex items-start justify-center w-full h-screen overflow-hidden opacity-75">
        <div className="relative z-20 w-1/2">
          <div className="absolute top-0 left-0 w-full h-screen bg-gradient-to-r from-stone-700 to-stone-700"></div>
        </div>
        <div className="relative z-10 w-1/2 ">
          ...
          <div className="absolute top-0 left-0 z-30 w-full h-screen bg-gradient-to-r from-stone-700 t to-transparent"></div>
        </div>
      </div>
    </div>
  );
