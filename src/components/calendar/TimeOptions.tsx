...
const TimeOptions: FC<Props> = (props) => {
  ...
  return selectedTimeZone !== '' ? (
    <div className="max-w-60 absolute z-10 w-1/2 rounded-sm border border-gray-200 bg-white px-4 py-2 dark:border-0 dark:bg-gray-700">
      ...
      <TimezoneSelect
        ...
        className="focus:border-brand mt-1 mb-2 block w-full rounded-md border-gray-300 shadow-sm focus:ring-black sm:text-sm text-black"
      />
    </div>
  ) : null;
};
